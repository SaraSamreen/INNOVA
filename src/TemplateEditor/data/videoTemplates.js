// Updated videoTemplates.js with Premium Features
      ...
      scenes: [
        {
          ...
          avatar: "james",
          voiceSettings: { voice: "James - Friendly", emotion: "Natural" },
          elements: [
            {
              id: "product-title",
              type: "text",
      ...
      scenes: [
        {
          ...
          avatar: "emma",
          voiceSettings: { voice: "Emma - Energetic", emotion: "Natural" },
          elements: [
            {
              id: "trust-title",
              type: "text",
      ...
      scenes: [
        {
          ...
          avatar: "emma",
          voiceSettings: { voice: "Emma - Energetic", emotion: "Excited" },
          elements: [
            {
              id: "sale-title",
              type: "text",
